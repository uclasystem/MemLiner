...
#ifndef SHARE_VM_GC_G1_G1CONCURRENTPREFETCHTHREAD_HPP
#define SHARE_VM_GC_G1_G1CONCURRENTPREFETCHTHREAD_HPP
...
class G1ConcurrentPrefetchThread: public ConcurrentGCThread {
 ...
 public:
  // Constructor
  G1ConcurrentPrefetchThread(G1ConcurrentPrefetch* pf, G1ConcurrentMark* cm);
